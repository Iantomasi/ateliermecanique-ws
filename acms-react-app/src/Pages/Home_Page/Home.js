          ...
          <section className="flex flex-col md:flex-row hero bg-white p-4 md:p-8">
            <div className="flex flex-col justify-center md:w-1/2 lg:w-2/5">
              <h1 className="text-3xl md:text-4xl lg:text-5xl">
                Revitalize your ride with expert care with SIUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU.
              </h1>
              <img src="https://e00-mx-marca.uecdn.es/mx/assets/multimedia/imagenes/2023/08/09/16915591469321.jpg" alt="Car" style={{height:"30vh", width:"30vh"}} />
